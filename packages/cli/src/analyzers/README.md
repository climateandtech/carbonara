...
The Byte Counter Analyzer is a built-in tool that estimates CO2 emissions from web page data transfer using established research and industry-standard methodologies.
...
```bash
# Basic analysis
carbonara analyze byte-counter https://example.com

# With custom grid intensity (e.g., for a specific country)
carbonara analyze byte-counter https://example.com --grid-intensity 334

# For returning visitors (loads less data)
carbonara analyze byte-counter https://example.com --returning-visitor
