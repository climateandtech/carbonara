...
export const GCP_REGION_MAPPINGS: Record<string, RegionGridMapping> = {
  ...
  "us-east1": {
    region: "us-east1",
    gridZone: "US-CAR-CPLE",
    location: "Moncks Corner, South Carolina, USA",
    country: "US",
    notes: "Duke Energy Progress East",
  },
  "us-east4": {
    region: "us-east4",
    gridZone: "US-MIDA-PJM",
    location: "Ashburn, N. Virginia, USA",
    country: "US",
    notes: "PJM Interconnection",
  },
  "us-east5": {
  ...
  "southamerica-west1": {
    ...
    country: "CL",
    notes: "Sistema Eléctrico Nacional",
  },
...
export const AZURE_REGION_MAPPINGS: Record<string, RegionGridMapping> = {
  ...
  "usgov-arizona": {
    ...
    country: "US",
    notes: "Azure Government - Arizona PS",
  },
  "usdod-central": {
    region: "usdod-central",
    gridZone: "US-MIDW-MISO",
    location: "Iowa, USA",
    country: "US",
    notes: "DoD - Midcontinent ISO",
  },
  "usdod-east": {
    region: "usdod-east",
    gridZone: "US-MIDA-PJM",
...
export const HEROKU_REGION_MAPPINGS: Record<string, RegionGridMapping> = {
  ...
  us: {
    region: "us",
    gridZone: "US-MIDA-PJM",
    location: "Virginia (AWS us-east-1), USA",
    country: "US",
    notes: "PJM Interconnection",
  },
  eu: {
    region: "eu",
    gridZone: "IE",
    location: "Dublin (AWS eu-west-1), Ireland",
    country: "IE",
  },
...
export const NETLIFY_REGION_MAPPINGS: Record<string, RegionGridMapping> = {
  ...
  "us-east-2": {
    region: "us-east-2",
    gridZone: "US-MIDW-MISO",
    location: "Ohio (AWS), USA",
    country: "US",
    notes: "Midcontinent ISO - Default region",
  },
  "us-west-1": {
    region: "us-west-1",
    gridZone: "US-CAL-CISO",
    location: "N. California (AWS), USA",
    country: "US",
    notes: "CAISO",
  },
  "us-west-2": {
  ...
  "eu-central-1": {
    region: "eu-central-1",
    gridZone: "DE",
    location: "Frankfurt (AWS), Germany",
    country: "DE",
  },
  "eu-west-2": {
    region: "eu-west-2",
    gridZone: "GB",
    location: "London (AWS), United Kingdom",
    country: "GB",
  },
  "ap-southeast-1": {
    region: "ap-southeast-1",
    gridZone: "SG",
    location: "Singapore (AWS), Singapore",
    country: "SG",
  },
};
 ...
 */
export function getGridZoneForRegion(
  provider: string,
  region: string
): string | null {
  const providerMappings =
    ALL_REGION_MAPPINGS[
      provider.toLowerCase() as keyof typeof ALL_REGION_MAPPINGS
    ];
  if (!providerMappings) {
    return null;
  }
