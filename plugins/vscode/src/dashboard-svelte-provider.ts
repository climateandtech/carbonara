...
export class DashboardSvelteProvider {
  ...
  public async showDashboard(): Promise<void> {
    ...
    if (DashboardSvelteProvider.currentPanel) {
      DashboardSvelteProvider.currentPanel.reveal(vscode.ViewColumn.One);
      return;
    }
    ...
    DashboardSvelteProvider.currentPanel = panel;
    ...
    panel.onDidDispose(
      () => {
        DashboardSvelteProvider.currentPanel = undefined;
      },
      null,
      this.context.subscriptions
    );
  ...
  private getHtmlForWebview(webview: vscode.Webview): string {
    ...
    const scriptPath = vscode.Uri.file(
      path.join(this.context.extensionPath, "dist", "webview", "dashboard-bundle.js")
    );
