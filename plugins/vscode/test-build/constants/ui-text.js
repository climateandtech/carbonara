...
exports.SELECTORS = exports.UI_TEXT = void 0;
exports.UI_TEXT = {
    // Status bar
    STATUS_BAR: {
    ...
    NOTIFICATIONS: {
        ...
        ANALYSIS_RUNNING: (toolName) => `Running ${toolName} analysis...`,
        ANALYSIS_COMPLETED: (toolName) => `${toolName} analysis completed!`,
        ANALYSIS_FAILED: "Analysis failed:",
        // Tool management notifications
        CLI_NOT_FOUND: "Carbonara CLI not found",
        TOOL_INSTALLING: (toolName) => `Installing ${toolName}...`,
        TOOL_INSTALLED: (toolName) => `${toolName} installed successfully!`,
        TOOL_INSTALL_FAILED: (toolName) => `Failed to install ${toolName}:`
    }
};
// CSS Selectors for tests
exports.SELECTORS = {
    STATUS_BAR: {
        ITEM: `a[role="button"][aria-label="${exports.UI_TEXT.STATUS_BAR.ARIA_LABEL}"]`,
        BUTTON: `a[role="button"][aria-label="${exports.UI_TEXT.STATUS_BAR.ARIA_LABEL}"]`,
    ...
    PROJECT_INIT: {
        ...
        TYPE_INPUT: `input[placeholder="${exports.UI_TEXT.PROJECT_INIT.TYPE_PLACEHOLDER}"]`
    },
    INPUT_BOX: {
    ...
    NOTIFICATIONS: {
        ...
        TOAST_WITH_TEXT: (text) => `.notifications-center .notification-toast:has-text("${text}")`
    }
};
